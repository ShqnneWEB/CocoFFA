...
StyleSetter<Component> {
    ...
    @Contract(value="_, _, _ -> new", pure=true)
    @NotNull
    public static <C> VirtualComponent virtual(@NotNull Class<C> contextType, @NotNull VirtualComponentRenderer<C> renderer, @NotNull StyleBuilderApplicable ... style) {
        Objects.requireNonNull(contextType, "context type");
        Objects.requireNonNull(renderer, "renderer");
    ...
    @Contract(pure=true)
    @NotNull
    default public Component append(@NotNull @NotNull ComponentLike @NotNull ... components) {
        if (components.length == 0) {
            return this;
        }
